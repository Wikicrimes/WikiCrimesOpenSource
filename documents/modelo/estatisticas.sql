...
---------
-- Trigger de Update
-- Verifica se os campos pais, cidade e estado antigos s�o nulos, se os campos novos campos s�o diferente de nulo e nao s�o vazios
-- A verifica��o dos campos novos se deve a confirma��es de crimes que ainda n�o tem os campos cidade, estado e pais
---------
