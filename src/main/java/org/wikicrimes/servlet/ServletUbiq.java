...
public class ServletUbiq extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//Para resolver o problema da codifica��o de caractere tem que setar um setHeade com o codigo
		...
		if(acao.equalsIgnoreCase("2")){
			/*String texto = "Na noite de s�bado �ltimo, um jovem identificado como " +
					"Geison Santos de Oliveira, foi executado com v�rios tiros. " +
					"O crime ocorreu na Rua Titan 33, que j� foi palco de diversos " +
			...
			conceitoRelacionado = Conceito.getConceitoBD("endere�o");
			//grafoConceitos.addConceito(conceitoRelacionado);
			conceitoRelacionado.populaArestasBD(paramF);
			perguntaAux.addConceitoRelacionado(conceitoRelacionado);
			...
			Conceito violencia = Conceito.getConceitoBD("viol�ncia");
			...
			Conceito homicidio = Conceito.getConceitoBD("homic�dio");
			...
			// Extrair informa��es conforme Objetivos
			if (objetivos!=null) {
...
//					}else{
//						endereco ="Endere�o n�o encontrado";
//					}
...
//				}
				...
				System.err.println("SIA N�o recebeu objetivos !!!");
			}
	...
	public static String convertStreamToStringResposta(InputStream in) {
		...
		try {
			while ((line = reader.readLine()) != null) {
				...
				//o fim da resposta � feito com a tag "</dl>"
				if (resposta) break;
			}
		} catch (IOException e) {
			e.printStackTrace();
