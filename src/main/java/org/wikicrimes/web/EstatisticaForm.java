...
/**
 * Form de consultas a tabela de crimes para gera��o da p�gina de estatisticas
...
public class EstatisticaForm extends GenericForm {
	...
	public String getgTemporalMundo() {
		...
		//String chtt = "&amp;chtt=�ltimos+6+meses";
		String cht = "&amp;cht=lc";
	...
	public String getgBarrasPais(){
		...
		if(local.equalsIgnoreCase("pt_BR")) {
			...
			")|Rixas ou Brigas(" + estPais.getQtdOutroRixas() + ")|Abusos de Autoridade(" + estPais.getQtdOutroAbusoAutoridade() + ")|Vilol�ncia Dom�stica(" + estPais.getQtdOutroViolenciaDomestica() + 
			")|Tentativas de Homic�dio(" + estPais.getQtdOutroTentativaHomicidio() + ")|Homic�dios(" + estPais.getQtdOutroHomicidio() + ")|Latroc�nio(" + estPais.getQtdOutroLatrocinio() + ")";
		} else {
	...
	public String getgBarrasEstado(){
		...
		if(local.equalsIgnoreCase("pt_BR")) {
			...
			")|Rixas ou Brigas(" + estEstado.getQtdOutroRixas() + ")|Abusos de Autoridade(" + estEstado.getQtdOutroAbusoAutoridade() + ")|Vilol�ncia Dom�stica(" + estEstado.getQtdOutroViolenciaDomestica() + 
			")|Tentativas de Homic�dio(" + estEstado.getQtdOutroTentativaHomicidio() + ")|Homic�dios(" + estEstado.getQtdOutroHomicidio() + ")|Latroc�nio(" + estEstado.getQtdOutroLatrocinio() + ")";
		} else {
	...
	public String getgBarrasCidade(){
		...
		if(local.equalsIgnoreCase("pt_BR")) {
			...
			")|Rixas ou Brigas(" + estCidade.getQtdOutroRixas() + ")|Abusos de Autoridade(" + estCidade.getQtdOutroAbusoAutoridade() + ")|Vilol�ncia Dom�stica(" + estCidade.getQtdOutroViolenciaDomestica() + 
			")|Tentativas de Homic�dio(" + estCidade.getQtdOutroTentativaHomicidio() + ")|Homic�dios(" + estCidade.getQtdOutroHomicidio() + ")|Latroc�nio(" + estCidade.getQtdOutroLatrocinio() + ")";
		} else {
	...
	private String codeUrl(String url){
		url = url.replace("�", "%C3%83");
		url = url.replace("�", "%C3%A3");
		url = url.replace("�", "%C3%81");
		url = url.replace("�", "%C3%A1");
		url = url.replace("�", "%C3%82");
		url = url.replace("�", "%C3%A2");
		url = url.replace("�", "%C3%89");
		url = url.replace("�", "%C3%A9");
		url = url.replace("�", "%C3%8A");
		url = url.replace("�", "%C3%AA");
		url = url.replace("�", "%C3%8E");
		url = url.replace("�", "%C3%AE");
		url = url.replace("�", "%C3%8D");
		url = url.replace("�", "%C3%AD");
		url = url.replace("�", "%C3%95");
		url = url.replace("�", "%C3%B5");
		url = url.replace("�", "%C3%94");
		url = url.replace("�", "%C3%B4");
		url = url.replace("�", "%C3%93");
		url = url.replace("�", "%C3%B3");
		url = url.replace("�", "%C3%9B");
		url = url.replace("�", "%C3%BB");
		url = url.replace("�", "%C3%9A");
		url = url.replace("�", "%C3%BA");
		url = url.replace("�", "%C3%80");
		url = url.replace("�", "%C3%A0");
		url = url.replace("�", "%C3%9C");
		url = url.replace("�", "%C3%BC");
		url = url.replace("�", "%C3%87");
		url = url.replace("�", "%C3%A7");
		url = url.replace("�", "%C3%99");
		url = url.replace("�", "%C3%B9");
		url = url.replace("�", "%C3%96");
